...
def query_to_docs_attention_heads(attentions, query_span, doc_spans, selected_heads):
    ...
    for (layer_id, head_id) in selected_heads:
        attn = attentions[layer_id][0, head_id]   # [N, N]
...
#     # suffix_ids = tokenizer("\nCorrect tool_id:", add_special_tokens=False).input_ids
...
#     # prefix_start = find_subseq(input_ids_list, prefix_ids)
#     # suffix_start = find_subseq(input_ids_list, suffix_ids)

#     # if prefix_start == -1:
#     #     raise ValueError("Could not find query prefix in input_ids.")
#     # if suffix_start == -1:
#     #     raise ValueError("Could not find query suffix in input_ids.")

#     # query_start = prefix_start + len(prefix_ids)
#     # query_end = suffix_start
